...
<link rel="canonical" href="https://doxadigitalventures.com/about.php" />
  ...
  <link
    ...
    rel="stylesheet"
  />
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@900&display=stylesheet" rel="stylesheet" />
  <!-- Font Awesome -->
  ...
  <!-- Corrected font link for Boldonse (fallback to available font) -->
...
<body>
  ...
  <section class="banner">
    ...
    <div class="container">
      <div class="banner-content">
        ...
        <p class="banner-subtitle">Driven by passion, built on trust</p>
      </div>
    </div>
  </section>
</div>
  <section class="next-section" id="about">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
  ...
  <section class="leader-section" id="leader">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <p class="section-text" data-line="1">  Our expert team drives your success with innovative strategies
          </p>
          <p class="section-text" data-line="2">  With more than 12+ years of experience in SEO, PPC, and content creation for measurable results</p>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        (entries, observer) => {
          entries.forEach((entry) => {
            if (entry.isIntersecting) {
              ...
              const cols = entry.target.querySelectorAll(".col-md-6");
  
              cols.forEach((col) => (col.style.opacity = "1"));
              if (title) title.classList.add("animate");
              texts.forEach((text, index) => {
                setTimeout(() => text.classList.add("animate"), index * 300);
              });
      ...
      leaderObserver.observe(document.querySelector("#leader"));
    });
  </script>
  <script>
