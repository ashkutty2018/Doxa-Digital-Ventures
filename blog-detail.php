...
<meta name="author" content="Doxa Digital Ventures">
  <title>Blog Detail - DOXA Digital Ventures</title>
  <!-- Favicon -->
  <link href="assets/img/doxa.png" rel="icon" />
<link rel="canonical" href="https://doxadigitalventures.com/blog-detail.php" />
  <!-- Fonts -->
  ...
  <script type="application/ld+json">
{
  ...
  <!-- Inline Styles for Blog Detail Section -->
  <style>
  ...
  body
    ...
    .blog-detail-image {
        ...
        min-height: 200px; /* Fallback height if image fails to load */
        background-color: #f0f0f0; /* Light gray background if image fails */
    }
    ...
    /* Ensure line breaks are respected in the content */
    ...
    .back-to-blogs:hover {
        background-color: #5a6268; /* Darker shade on hover (Bootstrap's btn-secondary default hover) */
    ...
    @media (max-width: 991px) {
        .blog-detail-title {
            font-size: 2rem; /* Smaller title on medium screens */
        }

        .blog-detail-image {
            max-height: 300px; /* Smaller image height on medium screens */
        }
    ...
    @media (max-width: 576px) {
        .blog-detail-title {
            font-size: 1.8rem; /* Even smaller title on small screens */
        }

        .blog-detail-image {
            max-height: 250px; /* Smaller image height on small screens */
        }

        .blog-detail-content {
            font-size: 0.95rem; /* Smaller text on small screens */
...
<body>
    ...
    <section class="banner">
      ...
      <div class="container">
        <div class="banner-content">
          ...
          <p class="banner-subtitle">Insights to Elevate Your Digital Journey</p>
        </div>
      </div>
    </section>
    ...
    <section class="blog-detail-section">
        <div class="container">
            ...
            if (!isset($_GET['id']) || !in_array($_GET['id'], ['1', '2', '3', '4'])) {
                echo '<div class="alert alert-danger" role="alert">Invalid blog ID.</div>';
                exit;
            }
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <a href="index.php" class="btn btn-secondary back-to-blogs">Back to Blogs</a>
                </div>
            </div>
        </div>
    </section>
  ...
  <footer class="combined-footer">
    <h2><img src="assets/img/white.png" height="50px" width="150px" alt="DOXA Logo"></h2>
